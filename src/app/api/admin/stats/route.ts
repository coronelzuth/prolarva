...
export async function POST(req: NextRequest) {
  try {
    ...
    const [lotesRes, cosechasRes, leadsRes, ventasRes] = await Promise.all([
    ...
    return NextResponse.json({ success: true, stats: { totalLotes, totalKg, totalLeads, totalVentasCOP, totalVentasCount } });
  } catch {
