...
function AdminView({ adminCode, onBack, onLogout }: { adminCode: string; onBack: () => void; onLogout: () => void }) {
  const [tab, setTab] = useState<'socios' | 'invitaciones' | 'blog' | 'leads' | 'ventas' | 'comunicacion' | 'contenido' | 'tripwire'>('socios');
  ...
  // ── Tripwire (Mini-Curso "Arranca tu Colonia BSF") state ────────────────────
